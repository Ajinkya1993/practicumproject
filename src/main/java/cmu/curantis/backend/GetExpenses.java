/**
 * This resource retrieves a given vendor’s expenditure.
 * 
 ...
 * }
 * 
 * Output fields: list, contactperson, expenses,circleId,day,month,vendorName,
 * notification, paymentsource, phoneno, remdays,  vendorAccount, vendorAddr, vendortype, vendorWebsite, 
 * Output Example:
 * {
 *   "bean": null,
 *   "list": [
